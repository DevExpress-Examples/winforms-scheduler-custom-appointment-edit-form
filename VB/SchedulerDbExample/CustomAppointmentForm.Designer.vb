...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnDelete.Click += new System.EventHandler(this.OnBtnDeleteClick);
			' 
			' btnRecurrence
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnRecurrence.Click += new System.EventHandler(this.OnBtnRecurrenceClick);
			' 
			' edtStartDate
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.Activated += new System.EventHandler(this.OnAppointmentFormActivated);
